...
function isAphaNumericWithBasics(text) {
...
async function sharedHaikuLogic(formData,  user) {
    ...
    if(ourHaiku.line2.length > 35) errors.line3 = "Too many syllables; must be 35."

    if(ourHaiku.line3.length < 8) errors.line3 = "Too few syllables; must be more than 8."
    if(ourHaiku.line3.length > 28) errors.line3 = "Too many syllables; must be 25."

    if(!isAphaNumericWithBasics(ourHaiku.line1)) errors.line1 = "No special characters please."
    if(!isAphaNumericWithBasics(ourHaiku.line2)) errors.line2 = "No special characters please."
    if(!isAphaNumericWithBasics(ourHaiku.line3)) errors.line3 = "No special characters please."
